...
const ContactUs = () => {
    return (
        <React.Fragment>
            <section className="content-container container-2">
                <div className="textArea text-2">
                    <h2>Contact Us</h2>
                    <p>
                                ...
                                <table>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Fidus Information Security ,<br />
                                                Company No 10684689 | One Central Boulevard, Shirley, Solihull, England, B90 8BG<br />
